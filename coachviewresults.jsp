...
-->
  ...
  <li class="scroll-to-section"><a href="student.html">Logout</a></li>
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <h6 style="font-size:30px;">Welcome Coach,<%= session.getAttribute("UserName") %></h6><br><br>
	             <table align="center" style="font-size:22px;" width=100% border=2>
	...
	<%
	  ...
	  {%>
	    <tr>
<tH><a href="viewtmdetials.jsp?tid=<%=rs.getString(1) %>" target="_blank"><%= rs.getString(1) %></th>
 ...
 <tr><td colspan=4 align="center"><a href="coachhome.jsp">Back</td></tr>
            </div>
        </div>
    </div>
