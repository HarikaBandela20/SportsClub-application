...
<tr><td align="center" colspan=5>Coordinator Details</td></tr>
 <tr><th>UserName</th><th>EmailId</th><th>MobileNumber</th><th>CollegeName</th> <th>Address</th></tr>
  <%@include file="DBConn.jsp" %>
  <%
    PreparedStatement pst=con.prepareStatement("Select * from coordinator");
	...
	<%}
  %>
  <tr><td align="center" colspan=5><a href="adminhome.jsp">Back</td></tr>
</table>     
            </div>
        </div>
    </div>
