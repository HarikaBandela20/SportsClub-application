    ...
    <header class="header-area header-sticky">
        <div class="container">
            ...
            <a href="index.html" class="logo"><em> SPORTS CLUB</em></a>
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
  <li class="scroll-to-section"><a href="coordinator.html">Logout</a></li>
                        </ul>        
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
           <h6 style="font-size:30px;">Welcome Coordinator,<%= session.getAttribute("UserName") %></h6><br><br>
	       <table align="center" width=40% style="font-size:22px;">
		 <tr><td align="Center" colspan=2>Enter Tournament Results</td></tr>
		 <form action="updatetournamnetdetails2.jsp" method="post">
		 <%@include file="DBConn.jsp"%>
	<tr><th>TournamentId</th><th><input type="text" name="tid" value="<%= request.getParameter("tid") %>" /></th></tr>
	<tr><th>Winner</th><th><select name="winner" >
	
	<%
	String tid=request.getParameter("tid");
	  String user=(String)session.getAttribute("UserName");
PreparedStatement pst=con.prepareStatement("select college from coachrequests where status=1");
...
<tr><th>Second Place</th><th><select name="second" >
	
	<%
	
PreparedStatement pst1=con.prepareStatement("select college from coachrequests where status=1");
...
<tr><th><input type="submit" value="Declare Result" /></th>
