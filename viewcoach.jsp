...
tr:hover {background-color:black;}
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <h6 style="font-size:30px;">Welcome Admin</h6><br><br>
				 ...
				 <tr><td align="center" colspan=6>Coach Details</td></tr>
  <tr><th>UserName</th><th>EmailId</th><th>MobileNumber</th><th>CollegeName</th><th>Address</th><th>Sport</th></tr>
  ...
  <%
	...
	<%}
  %>
  <tr><td align="center" colspan=6><a href="adminhome.jsp">Back</td></tr>
</table>     
            </div>
        </div>
    </div>
