...
-->
  ...
  <li class="scroll-to-section"><a href="admin.html">Logout</a></li>
   ...
   <form action="addcollege1.jsp" method="post">
   <tr><th>CollegeName</th><th><input type="text" name="cname" required placeholder="Enter College Name" /></th></tr>
   <tr><th>District</th><th><input type="text" name="district" required placeholder="Enter District" /></th></tr>
   <tr><th>Address</th><th><textarea name="address" rows=5 cols=20>
   </textarea></th></tr>
   <tr><th>PinCode</th><th><input type="number" name="pincode" required /></th></tr>
   <tr>
   <Th><input type="submit" value="Submit" /></th>
   <th><input type="reset" value="Reset" /></th>
   </tr>
   <tr><td align="center" colspan=2><br><a href="adminhome.jsp">Back</a></td></tr>
   </form>
   </table>
