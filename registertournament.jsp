  ...
  <li class="scroll-to-section"><a href="coordinator.html">Logout</a></li>
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
	     ...
	     <table align="center" border=2 width=80% style="font-size:23px;color:white;">
	<tr><th>CoachName</th><th>College</th><th>TournamentId</th><th>Operation</th></tr>
	<%@include file="DBConn.jsp" %>
	<%
	  String college=(String)session.getAttribute("CName");
	  PreparedStatement pst=con.prepareStatement("Select * from coachrequests where college=? and status=0");
	  ...
	  {%>
	    <Tr>
		  ...
		  <th><a href="coordinatoraccept.jsp?crid=<%= rs.getString(1) %>">Accept</a></th>
		</tr>
	  <%}
	%>
	<tr><td colspan=4 align="center"><a href="coordinatorhome.jsp">Back</td></tr>
