    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
	            ...
	            <table align="center" style="font-size:22px;color:white" width=100% border=2>
	<%@include file="DBConn.jsp" %>
	<tr><th>Student Name</th><th>College</th><th>TournamentID</th>
	<th>Operation</th></tr>
...
PreparedStatement pst=con.prepareStatement("Select * from userrequests where college=? and status=0");
...
{%>
    <tr>
	 ...
	 <th><a href="studentaccept.jsp?reqid=<%= rs.getString(1) %>"> Accept/</a>
	 <a href="studentreject.jsp?reqid=<%= rs.getString(1) %>"> reject</a>
	 </th>  
	</tr>
<%}
	%>
	<Tr><td align="center" colspan=4><a href="coachhome.jsp">Back</a></td></tr>
	</table>
