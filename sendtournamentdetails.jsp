    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
				 ...
				 <form action="sendtournamentdetails1.jsp" method="post">
<tr><td align="center" colspan=2 style="Color:white;">Enter Tournament Details</td></tr><br><br><br>
...
<Tr><th>College Name</th><th><input type="text" name="cname" required /></th></tr>
<tr><Th>Address</th><Th><textarea rows=5 cols=25 name="address">
</textarea></th></tr>
<tr><th>From Date</th><Th><input type="date" name="fdate" required/></th></tr>
<tr><th>To Date</th><th><input type="date" name="tdate" required/></th></tr>
<tr><th>Timings</th><th><input type="time" name="time" required/></th></tr>
<tr><th>EntryFee</th><th><input type="number" name="efee" required/></th></tr>
<tr><th>Contact Number</th><th><input type="text" name="cno" pattern="[0-9]{10}" required /></th></tr>
<tr><th><input type="submit" value="submit" /></th>
<th><input type="reset" value="reset" /></th></tr>
</form>
<tr><td colspan=2 align="center"><a href="coordinatorhome.jsp">Back</td></tr>
				 </table>
            </div>
        </div>
    </div>
