  ...
  <li class="scroll-to-section"><a href="student.html">Logout</a></li>
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <h6 style="font-size:30px;">Welcome Coach,<%= session.getAttribute("UserName") %></h6><br><br>
	            <table align="center" style="font-size:18px;color:white" width=100% border=2>
	<%@include file="DBConn.jsp" %>
	<tr><th>Sport</th><TH>College Name</th><th>Address</th><th>From date</th>
	<th>To Date</th><th>Start Time</th><th>Entry Fee</th><th>Coordinator Name</th><th>Contact Number</th><th>Operation</th></tr>
	<%
	   String user=(String)session.getAttribute("UserName");
PreparedStatement pst=con.prepareStatement("Select * from tournament where status=1");
...
<th><a href="coachrequesttocoordinator.jsp?tid=<%= rs.getString(1) %>"> Participate</a></th>
	</tr>
<%}
	%>
	<Tr><td align="center" colspan=10><a href="coachhome.jsp">Back</a></td></tr>
	</table>
