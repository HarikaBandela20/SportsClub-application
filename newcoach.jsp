...
-->
  ...
  <li class="scroll-to-section"><a href="student.html">Student</a></li>
  <li class="scroll-to-section"><a href="admin.html">Admin</a></li>
<li class="scroll-to-section"><a href="coach.html">Coach</a></li>
  <li class="scroll-to-section"><a href="coordinator.html">Coordinator</a></li>
  ...
  <li class="scroll-to-section"><a href="#contact-us">Contact</a></li> 
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <h6 style="font-size:30px;">Welcome Coach</h6><br><br>
				<table align="center" width=50% style="font-size:22px;">
		<form action="newcoach1.jsp" method="post">
<tr><th>UserName</th><th><input type="text" name="user" placeholder="Enter UserName" required /></th></tr>
<tr><th>Password</th><th><input type="password" name="pwd" placeholder="Enter Password" required /></th></tr>
<tr><th>EmailId</th><th><input type="email" name="email" placeholder="Enter EmailID" required /></th></tr>
<tr><th>MobileNumber</th><th><input type="text" name="mno" placeholder="Enter 10 digit number" pattern="[0-9]{10}" /></th></tr>
<tr><Th>College</th><th><select name="college">
  <%@include file="DBConn.jsp" %>
  <%
     PreparedStatement pst=con.prepareStatement("select * from college");
...
<tr><th>Address</th><th><textarea rows=5 cols=20 name="address">
</textarea></th></tr>
<tr><th>Sport</th><th><select name="sport" >
  <option value="BasketBall">Basket Ball
  <option value="VolleyBall">VolleyBall
  <option value="ThrowBall">ThrowBall
