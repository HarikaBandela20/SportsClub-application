...
-->
  ...
  <li class="scroll-to-section"><a href="student.html">Logout</a></li>
	...
	<th>To Date</th><th>StartTime</th><th>Entry Fee</th><th>Operation</th></tr>
	<%
...
<th><a href="sendconfirmation.jsp?tid=<%= rs.getString(1) %>">Send Request</a></th>
	</tr>
<%}
	%>
	<Tr><td align="center" colspan=8><a href="studenthome.jsp">Back</a></td></tr>
	</table>
	</div>
        </div>
    </div>
