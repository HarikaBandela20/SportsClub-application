  ...
  <li class="scroll-to-section"><a href="admin.html">Logout</a></li>
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <h6 style="font-size:30px;">Welcome Admin</h6><br><br>
				<%@include file="DBConn.jsp" %>
	<table align="center" width=100% style="font-size:20px;" border=2>
	<tr><th>Tournament Id</th><th>Sport</th>
	<th>College Name</th><th>Address</th><th>From Date</th><th>To Date</th><Th>Time</th><th>Entry Fee</th><th>Mobile Number</th><th>Coordinator name</th><th>Operation</th></tr>
	<%
	  PreparedStatement pst=con.prepareStatement("Select * from tournament where status=0");
	  ...
	  {%>
	      <tr>
			...
			<th><%= rs.getString(7) %></th><th><%= rs.getString(8) %></th>
			<th><%= rs.getString(10) %></th><th><%= rs.getString(11) %></th>
	<th><a href="addtour.jsp?tid=<%= rs.getString(1) %>">Accept/</a>
	<a href="rejtour.jsp?tid=<%= rs.getString(1) %>">Reject</a></th>
		  </tr>
	  <%}
	%>
	<tr><td colspan=11 align="center"><a href="adminhome.jsp">Back</a></td></tr>
	</table>
            </div>
        </div>
    </div>
